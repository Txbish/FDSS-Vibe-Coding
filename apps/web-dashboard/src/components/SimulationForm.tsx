...
import type { SimulationInput, Asset, Liability, TaxConfig } from '@future-wallet/shared-types';
...
export function SimulationForm({ onSubmit, onBranch, loading, hasResult }: SimulationFormProps) {
  ...
  const addExchangeRate = () => {
    setExchangeRates([
      ...exchangeRates,
      { from: exchangeFrom, to: exchangeTo, rate: exchangeRateVal, date: '2026-01-01' },
    ]);
  };
